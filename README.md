...
This repository contains the deliverables for a Data and applications course project, aimed at developing a comprehensive Portfolio Management System. The project is divided into four phases, each building on the previous one to progressively develop and refine the system.
...
The schema diagram in Phase 1 provides a visual representation of the database structure, including tables, relationships, and key constraints. This forms the foundation for the database design.
...
This repository provides a comprehensive overview of the development of a Portfolio Management System, from initial requirements gathering to final implementation. The detailed documents and source code offer a thorough understanding of the system's design, functionality, and evolution through each phase of the project.

For more information, refer to the respective documents and files included in each phase directory.
